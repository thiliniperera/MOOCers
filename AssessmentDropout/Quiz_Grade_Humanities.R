#read file
newTrainData <- read.csv("E:/My Documents/1.ENGI/Semester 8/FYP/EDUC115/HumanitiesandScience_StatLearning_Winter2015_ActivityGrade.csv")
finalData <- read.csv("E:/My Documents/1.ENGI/Semester 8/FYP/EDUC115/HumanitiesandScience_StatLearning_Winter2015_FinalGrade.csv")
