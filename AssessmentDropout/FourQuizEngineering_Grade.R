#read file
newTrainData <- read.csv("E:/My Documents/1.ENGI/Semester 8/FYP/EDUC115/Engineering_CS101_Summer2014_ActivityGrade.csv")
finalData <- read.csv("E:/My Documents/1.ENGI/Semester 8/FYP/EDUC115/Engineering_CS101_Summer2014_FinalGrade.csv")
